...
parser.add_argument('-t', '--train_data', type=str, required=True,
                    help='Train data use for the training)')
args = parser.parse_args()

# Set paths and names based on the disfluency event
folder_train_stutter = args.train_data
if args.disfluency == "block":
    file_save_name = 'blk'
    folder_save_stutter = 'Block'
    train_path_stutter = f'/content/drive/MyDrive/Ulima/Data/{folder_train_stutter}/{folder_save_stutter}'
    test_path_stutter = f'/content/drive/MyDrive/Ulima/Data/test_data/{folder_save_stutter}'
    # ... other event-specific settings ...
elif args.disfluency == "prolongation":
    file_save_name = 'pro'
    folder_save_stutter = 'Prolongation'
    train_path_stutter = f'/content/drive/MyDrive/Ulima/Data/{folder_train_stutter}/{folder_save_stutter}'
    test_path_stutter = f'/content/drive/MyDrive/Ulima/Data/test_data/{folder_save_stutter}'
# ... other disfluency types ...
elif args.disfluency == "sound repetition":
    file_save_name = 'snd'
    folder_save_stutter = 'SoundRep'
    train_path_stutter = f'/content/drive/MyDrive/Ulima/Data/{folder_train_stutter}/{folder_save_stutter}'
    test_path_stutter = f'/content/drive/MyDrive/Ulima/Data/test_data/{folder_save_stutter}'

elif args.disfluency == "word repetition":
    file_save_name = 'wp'
    folder_save_stutter = 'WordRep'
    train_path_stutter = f'/content/drive/MyDrive/Ulima/Data/{folder_train_stutter}/{folder_save_stutter}'
    test_path_stutter = f'/content/drive/MyDrive/Ulima/Data/test_data/{folder_save_stutter}'

# get data no stuttered
