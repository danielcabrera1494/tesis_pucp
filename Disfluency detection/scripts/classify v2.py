...
def process_directory(directory, model, device, bundle, true_labels):
    results = []
    predictions = []
...
if len(true_labels) > 0:
    process_directory(audio_directory, model, device, bundle, true_labels)
else:
