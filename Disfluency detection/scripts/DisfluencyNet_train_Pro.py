...
file_save_name = 'pro'
folder_save_stutter = 'Prolongations'

# get all data
train_path_stutter = f'/content/drive/MyDrive/Ulima/Data/{folder_train_sttuter}/Prolongation'
train_path_fluent  = '/content/drive/MyDrive/Ulima/Data/train_data/NoStutteredWords'
test_path_stutter  = '/content/drive/MyDrive/Ulima/Data/test_data/Prolongation'
