...
file_save_name = 'snd'
folder_save_stutter = 'Sound_Repetition'

# get all data
train_path_stutter = f'/content/drive/MyDrive/Ulima/Data/{folder_train_sttuter}/SoundRep'
train_path_fluent  = '/content/drive/MyDrive/Ulima/Data/train_data/NoStutteredWords'
test_path_stutter  = '/content/drive/MyDrive/Ulima/Data/test_data/SoundRep'
